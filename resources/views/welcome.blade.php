                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <main class="mt-6 main-form">
                        ...
                        <div class="pt-6 flex flex-col items-center">
                            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" style="background: red">
                                Submit
                            </button>
                        </form>
                    </main>
